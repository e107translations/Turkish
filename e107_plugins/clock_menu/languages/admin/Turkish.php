...
|
|     $Source: /cvsroot/e107/e107_0.7/e107_plugins/clock_menu/languages/admin/Turkish.php,v $
|     $Revision: 1.4 $
...
define("CLOCK_AD_L7", "Tarih Öneki");
define("CLOCK_AD_L8", "Diliniz için gerekliyse tarihin önüne bir ek koymak için (örn. Fransızlar 'le' ya da Almanlar 'den' kullanırlar), bu alanı kullanın. Gerekmiyorsa boş bırakın.");
define("CLOCK_AD_L9", "Sonek 1");
define("CLOCK_AD_L10", "Sonek 2");
