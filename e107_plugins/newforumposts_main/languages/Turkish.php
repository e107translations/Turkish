...
|
|        $Source: ../e107_plugins/newforumposts_main/languages/Turkish.php $
|        $Revision: 1.0 $
|        $Date: 2007/02/07 12:08:38 $
|        $Author: admin $
|				 $Türkçe Çeviri : shadowtr (http://e107turkiye.com)
+---------------------------------------------------------------+
*/
define("NFPM_LAN_1", "Konu");
define("NFPM_LAN_2", "Gönderen");
define("NFPM_LAN_3", "Görüntülemeler");
...
define("NFPM_L4", "Hangi alanda aktif olsun?");
define("NFPM_L5", "Pasif");
define("NFPM_L6", "Sayfanın üstünde");
define("NFPM_L7", "Sayfanın altında");
define("NFPM_L8", "Başlık");
define("NFPM_L9", "Kaç tane yeni mesaj gösterilecek ?");
define("NFPM_L10", "Kaydırılabilir katman içinde gösterilsin mi?");
define("NFPM_L11", "Katman yüksekliði");
define("NFPM_L12", "Yeni Forum Mesajları Ayarları");
define("NFPM_L13", "Yeni Forum Mesajları Ayarlarını Güncelle");
