...
define("LAN_NEWS_85", "Kategoriye dön");
...
define("LAN_NEWS_308", "Belki de aşağıdaki haber öğelerden birini arıyoruz?");
define("LAN_NEWS_463", "Haber öğesi için belirtilen kategori yok - yakında kontrol edin.");
