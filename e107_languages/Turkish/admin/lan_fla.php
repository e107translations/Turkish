...
+----------------------------------------------------------------------------+
*/
define("FLALAN_2", "Başarısız giriş denemeleri görülmemiştir");
define("FLALAN_3", "Deneme(ler( silindi");
define("FLALAN_4", "Kullanıcı yanlış parola/kullanıcı adı kullanarak giriş yapmayı denemiş");
define("FLALAN_5", "IP(ler) yasaklandı");
define("FLALAN_7", "Veri");
define("FLALAN_8", "IP adresi/ Host");
define("FLALAN_10", "Sil / Seçilileri yasakla");
define("FLALAN_15", "Aşağırdaki IP ler totyasaklıdır - kullanıcılar 10 dan fazla deneme yapmış");
define("FLALAN_16", "Bu oto yasak listesini sil");
define("FLALAN_17", "Oto yasak listesi silindi");
define("FLALAN_18", "Değil yasağı IP adresi - IP--- beyaz günü");
