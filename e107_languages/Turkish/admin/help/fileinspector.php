...
$text = " file inspector, site serverindeki dosyalarınızı scan ve analiz eder.Şayet  inspector bir 
 e107 core dosyası bulursa özünün bozuk olup olmadığını kontrol eder.";

$ns -> tablerender("File Inspector Yardım", $text);
?>
