...
define("EXTLAN_11", "Alanın adı tabloda kayıtlı olacağından tek bir isim sahibi olması gerekmekte");
define("EXTLAN_12", "Alan Metni");
define("EXTLAN_13", "Sunulan sayfalarda gösterilecek alan adı");
define("EXTLAN_14", "Alan Tipi");
define("EXTLAN_15", "Alan İçerik Metni");
define("EXTLAN_16", "Varsayılan Değer");
define("EXTLAN_17", "Her satırda mümkün değeri girin <br /> VT tablosu için yardım a bakın.");
define("EXTLAN_18", "Gerekli");
define("EXTLAN_19", "Kullanıcılar kendi ayarlarını güncellerken buraya bir değer girmeleri gerekbilir.");
define("EXTLAN_20", "Hangi kullanıcılara görünür olacağını belirler.");
define("EXTLAN_21", "Kullanıcı ayarlarında kimin bu özelliği göreceğini belirler.");
define("EXTLAN_22", "Değeri kullanıcı sayfasında kimin göreceğini belirler <br />NOT: Bunu Salt Okunur yapmanız sadece üyelere ve yöneticiye gösterir.");
define("EXTLAN_23", "Genişletilmiş Alan Ekle");
define("EXTLAN_24", "Genişletilmiş Alan Güncelle");
define("EXTLAN_25", "Yukarı taşı");
define("EXTLAN_26", "Aşağı taşı");
...
define("EXTLAN_49", "Kullanıcı Gizleyebilme özelliği ver");
...
define("EXTLAN_53", "Geçerli girdi olduğunu eşleştirmek için regex kodunu girin <br />**regex sınırlıyıcıları gerklidir**");
...
define("EXTLAN_69", "aktifleştirildi");
define("EXTLAN_70", "HATA!! Alan:");
define("EXTLAN_71", "aktifleştirilemedi!");
define("EXTLAN_72", "pasifleştirildi");
define("EXTLAN_73", "pasifleştirilemedi!");
define("EXTLAN_74", "ayrılmış alan adı ve kullanılamaz.");
define("EXTLAN_75", "Alan ekleme hatası");
...
define("EXTLAN_78", "Dosya bulunamadı --DOSYA-- veri tablosu oluşturulmalı");
...
define("EXTLAN_HELP_2", "Radyo buton yardım metni");
define("EXTLAN_HELP_3", "Menü yardım metni");
define("EXTLAN_HELP_4", "<b><i>Değerler:</i></b><br />HERZAMAN 3 değer verilmeli:<br /><ol><li>dbtable</li><li> ID içeren alan</li><li>değer içeren alan</li></ol><br />");
define("EXTLAN_HELP_5", "Yazı alanı yardım metni");
define("EXTLAN_HELP_6", "Tamsayı yardım metni");
define("EXTLAN_HELP_7", "Tarhi yardım metni");
