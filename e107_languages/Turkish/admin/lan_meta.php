...
+----------------------------------------------------------------------------+
*/
define("METLAN_1", "Meta etiketler veritabanında güncellendi");
define("METLAN_2", "İlave meta-tag ekle");
define("METLAN_3", "Yeni meta tag ayarlarını gir");
define("METLAN_00", "Meta etiketleri");
